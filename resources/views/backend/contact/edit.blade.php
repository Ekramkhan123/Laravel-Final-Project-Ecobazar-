    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0 d-flex"><span><iconify-icon icon="material-symbols:note-add-outline-sharp" width="24" height="24"></iconify-icon></span>Contact Edit</h4>
                ...
                <form action="{{ route('dashboard.contact.update', $contact->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input name="address" type="text" class="form-control p-3 mb-3" placeholder="Address" 
                            ...
                            <div id="email-inputs-container">
                                @foreach($contact->emails as $email)
                                    <div class="email-input-group mb-3">
                                        <input type="email" name="emails[]" class="form-control p-2" 
                                            placeholder="Email address" value="{{ old('emails[]', $email->email) }}" required>
                            ...
                            <div id="number-inputs-container">
                                @foreach($contact->numbers as $number)
                                    <div class="number-input-group mb-3">
                                        <input type="text" name="numbers[]" class="form-control p-2" 
                                            placeholder="Phone number" value="{{ old('numbers[]', $number->number) }}" required>
                        ...
                        <div class="col-lg-12 mt-2">
                            <button type="submit" class="btn btn-primary mt-4 p-3 w-100">Update</button>
                        </div>
