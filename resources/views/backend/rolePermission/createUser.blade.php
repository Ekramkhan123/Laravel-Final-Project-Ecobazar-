                ...
                <div class="row">
                    <div class="col-lg-3 pt-3 ">
                        <label class="d-flex justify-content-center align-items-center" for="imgInp">
                            <img id="user_image" style="max-width: 200px; width: 100%; border: 1px solid rgb(238, 236, 236); padding:10px; cursor:pointer; border-radius: 8px;" class="img-fluid" src="{{ asset('assets/img/placeholder/placeholder.png') }}" alt="">
                        </label>
                    ...
                    <div class="col-lg-9 p-2">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="user_name" id="" class="form-control p-3" placeholder="User name">
                                @error('user_name')
                                    <p class="text-danger mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-lg-6">
                                ...
                                <input type="email" name="user_email" id="" class="form-control p-3" placeholder="User email">
                                @error('user_email')
                                    <p class="text-danger mt-2">{{ $message }}</p>
                                @enderror
                            </div>
