        ...
        <section id="heading_page" style="background-image: url('{{ asset('frontend/assets/image/vegetable_page/Breadcrumbs.png') }}');">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span>></span>
                    <a href="{{ route('frontend.shopping.cart') }}">Shopping Cart</a>
                    <span>></span>
                    <h4>Checkout</h4>
                </div>
            </div>
                    ...
                    <div class="col-xl-8 billing_address">
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <br>
                                <input name="street_address" id="street_address" type="text" placeholder="Address">
                            ...
                            <div class="col-xl-4">
                                ...
                                <br>
                                <input name="state" id="state" type="text" placeholder="States">
                                @error('state')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-xl-4">
                                ...
                                <br>
                                <input name="postcode" id="postcode" type="number" placeholder="Zip Code">
                                @error('postcode')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
