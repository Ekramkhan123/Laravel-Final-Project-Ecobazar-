...
<form id="customer-logout-form"
    ...
    <section id="customer">
        <div class="container">
            <div class="row">
                <!-- LEFT MENU -->
                <div class="col-xl-3 shoppingcart_menu">
                    @include('frontend.components.customer_navigation')
                </div>

                <!-- RIGHT CONTENT -->
                <div class="col-xl-9 customer_shoppingcart">
                    <div class="heading">
                    ...
                    <div class="row">
                        <div class="col-xl-8 shop_product">
                            <div class="row">
                                ...
                                <div class="col-xl-6 update">
                                    <a class="update_cart" href="{{ route('frontend.customer.shoppingcart') }}">Update cart</a>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                        ...
                        <div class="col-xl-3 cart-total">
                            ...
                            <a href="{{ route('frontend.customer.checkout') }}">
                                <div class="btn">
